...
const Job = ({ job }) => {
  ...
  return (
    <div className="p-6 rounded-2xl bg-gray-900 border border-gray-800 shadow-lg hover:border-indigo-600 transition-all duration-300">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button
          variant="outline"
          size="icon"
          className="rounded-full border-gray-700 bg-gray-800 text-gray-300 hover:bg-indigo-600 hover:text-white"
        >
          <Bookmark size={16} />
        </Button>
      </div>
