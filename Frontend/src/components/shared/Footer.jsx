...
//             <h2 className="text-xl font-bold">Talent Hunt</h2>
//             <p className="text-sm">©2025 Talent Hunt. All rights reserved.</p>
//           </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6 text-sm">
            <a href="#" className="hover:text-violet-400 transition duration-200">
              About
            </a>
            <a href="#" className="hover:text-violet-400 transition duration-200">
              Contact
